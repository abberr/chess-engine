...
public class EvaluatorTest {
    ...
    @Test
    public void test8() {
        board = new Board0x88("r3k2r/ppq2pp1/2pbp3/3pNb1p/2PPnP2/1QN1n2P/PP2B1P1/2R1BRN1 w - -");
        Move bestMove = Evaluator.findBestMove(board, SEARCH_DEPTH);
    ...
    @Test
    public void test9() {
        board = new Board0x88("r2k3r/pppqbpQp/8/3nP3/8/5P2/PPP3PP/1K1R1BNR b - - 0");
    ...
    @Test
    public void test10() {
        board = new Board0x88("r1r5/5k1p/1pNqppp1/pP1p4/P2PnP2/3QP3/2R3PP/2R3K1 w - -");
        Move bestMove = Evaluator.findBestMove(board, 6);
    ...
    @Test
    public void bugTest() {
        board = new Board0x88("rk1b4/ppp2Npp/4pn2/8/1P6/P3P3/1B3PPP/2R3K1 b - - 5 23 ");
